...
public class TicTacToeGame {
    ...
    public static void main(String[] args) {
        ...
        while (continues.equals("y")){
            ...
            while(tic.isGameFinished() != true && tic.isGameTied() != true )
            {
                tic.displayBoard();
                tic.playTurn();
            }
            ...
            tic.displayBoard();
            if (tic.isNextMovePlayer1)
            {
                System.out.println(tic.Player1Name + " has won the game!");
            }
            else
            {
                System.out.println(tic.Player2Name + " has won the game!");
            }      
